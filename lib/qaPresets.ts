...
export const DEFAULT_QA_ITEMS: Omit<QAItem, 'id' | 'event_id'>[] = [
  ...
  },
  {
    ...
    answer: 'あなたの氏名・所属/会社名・メールアドレスが、そのポスターの発表者に開示されます。「発表内容について後日質問したい」「名刺代わりに連絡先を交換したい」場合にご利用ください。',
    sort_order: 80
  },
  {
    target: 'participant',
  ...
  },
  {
    ...
    answer: '端末のログイン状態がクリアされます。フィードバック受付期間中は再ログインが可能ですが、受付終了（closed）後は再ログインできなくなりますので、必ず解約前にマイページから履歴を保存してください。受付終了の日時については、イベントの事務局に',
    sort_order: 120
  },
